---
title: Decision Tree model in python
author: ''
date: '2018-09-01'
slug: decision-tree-in-python
categories: [data,python,machine learning]
tags: []
lastmod: '2018-09-01T13:06:21+08:00'
layout: post
type: post
#highlight: no
description: 'Decision Tree model in python'
---

import pacakges and load iris dataset
...
print(len(X_test))
```
Traning default DecisionTree model give us overall testing accuracy：
```{python message=FALSE}
# define model
